                              ...
                              <div class="col-md-14">
                                  <div class="d-flex flex-row justify-content-between align-items-center  pb-2">
                                      <h3 class="text-secondary border-bottom mb-3 p-1"> 
                                        <i class="fas fa-edit" style="color:rgb(224, 204, 24)"></i> Modifier le fournisseur {{$fournisseur->nom}}
                                        </h3>
                                    ...
                                    @method('put')
                                       <div class="row mb-2 flex-container">
                                        <div class="col-xs-12 col-sm-4 ">
                                                ...
                                                <input type="text" class="form-control col-md-1 " name="nom" id="nom" value="{{$fournisseur->nom}}"><br>
                                        </div>
                                        <div class="col-xs-12 col-sm-3">
                                                <label for="genre"  class="col-form-label">Genre </label>
                                                <span class="required colorr" aria-hidden="true">*</span>
                                                <select name="genre" id="genre" class="form-control" style="color:#6f4826 ;background-color:#c5b998" >
                                           ...
                                           <div class=" mb-2 row flex-container">
                                            <div class="col-xs-12 col-sm-4"> 
                                                    ...
                                                    <span class="required colorr" aria-hidden="true">*</span>
                                                    <input type="text" class="form-control col-md-2"  value="{{$fournisseur->titre}}" id="titre" name="titre"><br>
                                            </div>
                                            <div class="col-xs-12 col-sm-4">
                                                <label for="domaine_activite"  class="col-form-label">Domaine activité </label>
                                                <span class="required colorr" aria-hidden="true">*</span>
                                                <input type="text" class="form-control col-md-4"  value="{{$fournisseur->domaine_activite}}" id=" domaine_activite" name="domaine_activite"><br>
                                            </div>
                                           </div>
                                           <div class=" mb-2 row flex-container">
                                            <div class="col-xs-12 col-sm-4"> 
                                                ...
                                                <span class="required colorr" aria-hidden="true">*</span>
                                                <input  class="form-control col-md-2"   value="{{$fournisseur->adresse}}" id="adresse" name="adresse">
                                           </div>
                                           <div class="col-xs-15 col-sm-2">
                                            <label for="code_postal"  class="col-form-label">Code postale</label>
                                            <span class="required colorr" aria-hidden="true">*</span>
                                            <input type="text" class="form-control col-md-2" value="{{$fournisseur->code_postal}}"  id="code_postal" name="code_postal">
                                           </div>
                                           </div>
                                           <div class="mb-2 row flex-container">
                                                <div class="col-xs-12 col-sm-4">
                                                    <label for="pays"  class="col-form-label">Pays:</label><br>
                                                    <select name="pays" id="pays" class="form-control col-md-2"  style="color:#6f4826 ;background-color:#c5b998" >
                                                    ...
                                                    <select name="ville" id="ville" class="form-control col-md-2" style="color:#6f4826 ;background-color:#c5b998" >
                                                ...
                                                <div class=" mb-2 row flex-container">
                                                    ...
                                                    <input type="text" class="form-control col-md-2" value="{{$fournisseur->curriel}}" id="curriel" name="curriel">
                                              </div>
                                              <div class="form-group mb-3 ">       
                                                  <label for="telephone" class="col-form-label">Télephone :</label>
                                                    <span class="required colorr" aria-hidden="true">*</span>
                                                    <input type="text" class="form-control col-md-2"  value="{{$fournisseur->telephone}}" id="telephone" name="telephone">
                                                </div>
                                             </div>
                                             <div class="row mb-2 flex-container">
                                                <div class="form-group mb-3 ">
                                                      <label for="site_internet" class="col-form-label"> Site internet :</label>
                                                      <input id="ContentPlaceHolder_TabsControl_ctl02_BusinessEditFormOld_WebSiteField" type="text" class="form-control col-md-2"  value="{{$fournisseur->site_internet}}" id="site_internet" name="site_internet"><a id="ContentPlaceHolder_TabsControl_ctl02_BusinessEditFormOld_WebSiteLink" href="http://" target="_blank"><i class="fa fa-external-link"></i></a>
                                                </div>
                                                <div class="form-group mb-3 ">
                                                    <label for="categorie_id"  class="col-form-label">Categorie </label>
                                                    <span class="required colorr" aria-hidden="true">*</span>
                                                    <select name="categorie_id"  class="form-control" style="color:#6f4826 ;background-color:#c5b998"  >
                                            ...
                                            <div class="row flex-container col-sm-6" style="margin:auto">
                                                ...
                                                <textarea name="note" id="note" class="form-control col-md-4" cols="40" rows="10"   placeholder="" >{{$fournisseur->note}}</textarea>
                                        </div>

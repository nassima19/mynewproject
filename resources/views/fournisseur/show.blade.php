                              ...
                              <div class="col-md-12">
                                <div class="d-flex flex-row justify-content-between align-items-center border-bottom pb-2">
                                    <h3 class="text-secondary border-bottom mb-3 p-1"> 
                                        <i class="fas fa-eye"style="font-size:30px;color:rgb(224, 204, 24) "></i> Détail de fournisseur {{$fournisseur->nom}}
                                      </h3>
                                      <a type="button" class="btn-close close" href="{{route("fournisseur.index")}}"></a>
                                </div>
                                    ...
                                    @method('put')
                                       <div class="row mb-2 flex-container">
                                        <div class="col-xs-12 col-sm-4 ">
                                                ...
                                                <input type="text" class="form-control col-md-1 " name="name" id="name" value="{{$fournisseur->nom}}"><br>
                                        </div>
                                        <div class="col-xs-12 col-sm-3">
                                           ...
                                           <div class="mb-2 row flex-container">
                                                <div class="col-xs-12 col-sm-4">
                                                    ...
                                                    <select name="pays" id="pays" class="form-control col-md-2"  style="color:#6f4826 ;background-color:#c5b998"  placeholder="{{$fournisseur->pays}}">
                                             ...
                                             <div class="row mb-2 flex-container">
                                               ...
                                               <div class="col-xs-12 col-sm-3">
                                                    ...
                                                    <span class="required colorr" aria-hidden="true">*</span>
                                                    <select name="categorie_id" id="categorie_id" class="form-control" style="color:#6f4826 ;background-color:#c5b998"  >

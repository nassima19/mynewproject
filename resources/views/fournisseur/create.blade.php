                                    ...
                                    @csrf
                                       <div class="row mb-2 flex-container">
                                        <div class="col-xs-12 col-sm-4 ">
                                                ...
                                                <input type="text" class="form-control col-md-1 " name="name" id="name" placeholder="Nom"><br>
                                        </div>
                                        <div class="col-xs-12 col-sm-3">
                                           ...
                                           <div class=" mb-2 row flex-container">
                                            <div class="col-xs-12 col-sm-4"> 
                                                    ...
                                                    <span class="required colorr" aria-hidden="true">*</span>
                                                    <input type="text" class="form-control col-md-2" placeholder="Titre" id="titre" name="titre"><br>
                                            </div>
                                            <div class="col-xs-12 col-sm-4">
                                                <label for="domaine_activite"  class="col-form-label">Domaine activité </label>
                                                <span class="required colorr" aria-hidden="true">*</span>
                                                <input type="text" class="form-control col-md-4" placeholder="Demaine d'activité" id=" domaine_activite" name="domaine_activite"><br>
                                            </div>
                                           </div>
                                           <div class=" mb-2 row flex-container">
                                            <div class="col-xs-12 col-sm-4"> 
                                                ...
                                                <span class="required colorr" aria-hidden="true">*</span>
                                                <input  class="form-control col-md-2" placeholder="Adresse" id="adresse" name="adresse">
                                           </div>
                                           <div class="col-xs-15 col-sm-2">
                                            <label for="code_postale"  class="col-form-label">Code postale</label>
                                            <span class="required colorr" aria-hidden="true">*</span>
                                            <input type="text" class="form-control col-md-2" placeholder="Code postale" id="code_postale" name="code_postale">
                                           </div>
                                           </div>
                                           <div class="mb-2 row flex-container">
                                                <div class="col-xs-12 col-sm-4">
                                                ...
                                                <div class=" mb-2 row flex-container">
                                                    ...
                                                    <input type="text" class="form-control col-md-2" placeholder="Curriel" id="curriel" name="curriel">
                                              </div>
                                              <div class="col-xs-12 col-sm-4">
                                                    <label for="telephone"  class="col-form-label">Telephone</label>
                                                    <span class="required colorr" aria-hidden="true">*</span>
                                                    <input type="text" class="form-control col-md-2" placeholder="Telephone" id="Telephone" name="Telephone">
                                                </div>
                                             </div>
                                             <div class="row mb-2 flex-container">
                                                <div class="col-xs-12 col-sm-4">
                                                      <label for="site_internet" class="col-form-label"> Site internet :</label>
                                                      <input id="ContentPlaceHolder_TabsControl_ctl02_BusinessEditFormOld_WebSiteField" type="text" class="form-control col-md-2" placeholder="Site internet" id="site_internet" name="site_internet"><a id="ContentPlaceHolder_TabsControl_ctl02_BusinessEditFormOld_WebSiteLink" href="http://" target="_blank"><i class="fa fa-external-link"></i></a>
                                                </div>
                                               <div class="col-xs-12 col-sm-3">
                                                    <label for="categorie"  class="col-form-label">Categorie </label>
                                                    <span class="required colorr" aria-hidden="true">*</span>
                                                     <select  name="categorie"   class="form-control" style="color:#6f4826 ;background-color:#c5b998">

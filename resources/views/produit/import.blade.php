        ...
        <div class="col-md-14 card shadow p-3 mb-5 bg-body rounded">
                <div class="card-body">
                    <div class="row"> 
                     ...
                     <div class="d-flex flex-row justify-content-between align-items-center  pb-2">
                                <h3 class="border-bottom mb-3 p-2" style="color: #a45e5f"> <i class="fa fa-cloud-upload" aria-hidden="true"></i> Importer produit
                                  </h3>
                    </div><br>
                <form action="{{ route('uploadP') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group pull-right" >
                        <button type="submit" class="btn2 " > Importer produit </button>
                        <button class="btn2 "><a type="button" style="text-decoration: none;  color:white"  href="{{route("produit.index")}}" > Annuler</a></button>
                    </div>
                </form>
               </div> 
            </div>

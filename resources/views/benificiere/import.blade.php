                ...
                <div class="card-body">
                    <div class="row"> 
                        <x-slot name="header">
                            ...
                            <a href="{{route("benificiere.index")}}">
                            <button type="button" class="ajouter import"><i class="fa fa-arrow-left" style="font-size:23px;"></i> Retour </button>
                        </a>  
                    </h2>
                    </x-slot> 
                     <div class="d-flex flex-row justify-content-between align-items-center  pb-2">
                                <h3 class="border-bottom mb-3 p-2" style="color: #a45e5f"> <i class="fa fa-cloud-upload" aria-hidden="true"></i> Importer bénéficiaire
                                  </h3>
                    </div><br>
                <form action="{{ route('uploadB') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group pull-right" >
                        <button type="submit" class="btn2 " > Importer bénéficiaire </button>
                        <button class="btn2 "><a type="button" style="text-decoration: none;  color:white"  href="{{route("benificiere.index")}}" > Annuler</a></button>
                    </div>
                </form>
               </div> 
            </div>
